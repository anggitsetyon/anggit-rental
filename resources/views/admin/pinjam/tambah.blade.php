...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Mobil Pesanan Diambil</h4>
            <form action="{{ route('admin.pinjam.simpan') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label>Nota</label>
                    <input type="file" name="nota" class="file-upload-default" accept="image/*">
                    <div class="input-group col-xs-12">
                        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Nota">
